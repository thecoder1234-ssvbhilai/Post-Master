console.log('This is my postmaster from javascript');
...
addParam.addEventListener('click', ()=>{
    ...
    let string = `<div class="row my-2 main">
                    ...
                    <div class="col-md-1 -mt-[23px]">
                        <button class="btn btn-primary mt-4 deleteParam">-</button>
                    </div>
                </div>`;
    ...
    for (item of deleteParam){
        item.addEventListener('click', (e)=>{
            var confirmDelete = confirm('Do you want to delete this parameter...')
...
submit.addEventListener('click', ()=>{
    ...
    if (contentType == 'params'){
        ...
        for(let i = 0; i < addedParamCount + 1; i++){
            if (document.getElementById('parameterKey' + (i + 1)) != undefined){
                ...
                let dValue = document.getElementById('parameterValue' + (i + 1)).value;
                data[key] = dValue;
            }
        }
    ...
    // id the request type is post, invoke fetch api to create a post request
    if (requestType=='GET'){
        fetch(url, {
            method: 'GET',
        })
